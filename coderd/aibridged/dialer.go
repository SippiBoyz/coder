...
// Gateway to coderd's /api/v2/aibridge/serve endpoint over a WebSocket,
// multiplexes it with yamux, and exposes the aibridged DRPC services
// (Recorder, MCPConfigurator, Authorizer) over it. This is the
// standalone counterpart to API.CreateInMemoryAIBridgeServer, which wires
// the same services over an in-memory pipe for the embedded daemon.
//
