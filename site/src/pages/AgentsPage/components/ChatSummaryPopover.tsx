...
export const ChatSummaryPopoverContent: FC<ChatSummaryPopoverContentProps> = ({
	...
	return (
		...
		>
			{chatData ? (
				<ChatSummary
					// The whole-chat summary text source is a deferred follow-up.
					// Pass a placeholder so the popover shows a muted empty state
					// rather than the terse last-turn status label.
					summary={null}
